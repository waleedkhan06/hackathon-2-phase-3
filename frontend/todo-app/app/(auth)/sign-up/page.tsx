  ...
  const onSubmit = async (data: SignUpFormData) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        if (errorText.includes('email already') || errorText.includes('user exists') || errorText.includes('duplicate')) {
          errorMessage = 'A user with this email already exists. Please sign in or use a different email.';
        } else if (errorText.includes('weak password') || errorText.includes('password too short')) {
