  ...
  const onSubmit = async (data: SignInFormData) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        if (errorText.includes('invalid credentials') || errorText.includes('incorrect email') || errorText.includes('incorrect password')) {
          errorMessage = 'Invalid email or password. Please check your credentials and try again.';
        } else if (errorText.includes('email not found') || errorText.includes('user not found')) {
